...
`timescale 1 ps / 1 ps
module QSYS_lab4_mm_interconnect_2 (
	...
	wire  [116:0] ready_from_hps_s1_agent_rf_source_data;                            // ready_from_HPS_s1_agent:rf_source_data -> ready_from_HPS_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] ready_from_hps_s1_agent_rsp_fifo_out_data;                         // ready_from_HPS_s1_agent_rsp_fifo:out_data -> ready_from_HPS_s1_agent:rf_sink_data
	...
	wire  [116:0] done_from_sdram_master_s1_agent_rf_source_data;                    // done_from_sdram_master_s1_agent:rf_source_data -> done_from_sdram_master_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] done_from_sdram_master_s1_agent_rsp_fifo_out_data;                 // done_from_sdram_master_s1_agent_rsp_fifo:out_data -> done_from_sdram_master_s1_agent:rf_sink_data
	...
	wire  [115:0] switches_s1_agent_rp_data;                                         // switches_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] ready_from_hps_s1_agent_rp_data;                                   // ready_from_HPS_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] done_from_sdram_master_s1_agent_rp_data;                           // done_from_sdram_master_s1_agent:rp_data -> router_008:sink_data
	...
	wire    [6:0] cmd_mux_001_src_channel;                                           // cmd_mux_001:src_channel -> alt_vip_vfr_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire    [6:0] alt_vip_vfr_0_avalon_slave_burst_adapter_source0_channel;          // alt_vip_vfr_0_avalon_slave_burst_adapter:source0_channel -> alt_vip_vfr_0_avalon_slave_agent:cp_channel
	...
	wire    [6:0] cmd_mux_002_src_channel;                                           // cmd_mux_002:src_channel -> sysid_qsys_0_control_slave_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_003_src_data;                                              // cmd_mux_003:src_data -> switches_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                             // switches_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                           // cmd_mux_003:src_channel -> switches_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] cmd_mux_004_src_channel;                                           // cmd_mux_004:src_channel -> leds_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_005_src_data;                                              // cmd_mux_005:src_data -> ready_from_HPS_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                             // ready_from_HPS_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                           // cmd_mux_005:src_channel -> ready_from_HPS_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] ready_from_hps_s1_burst_adapter_source0_data;                      // ready_from_HPS_s1_burst_adapter:source0_data -> ready_from_HPS_s1_agent:cp_data
	...
	wire    [6:0] ready_from_hps_s1_burst_adapter_source0_channel;                   // ready_from_HPS_s1_burst_adapter:source0_channel -> ready_from_HPS_s1_agent:cp_channel
	...
	wire  [115:0] cmd_mux_006_src_data;                                              // cmd_mux_006:src_data -> done_from_sdram_master_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                             // done_from_sdram_master_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                           // cmd_mux_006:src_channel -> done_from_sdram_master_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] done_from_sdram_master_s1_burst_adapter_source0_data;              // done_from_sdram_master_s1_burst_adapter:source0_data -> done_from_sdram_master_s1_agent:cp_data
	...
	wire    [6:0] done_from_sdram_master_s1_burst_adapter_source0_channel;           // done_from_sdram_master_s1_burst_adapter:source0_channel -> done_from_sdram_master_s1_agent:cp_channel
	...
	QSYS_lab4_mm_interconnect_2_router router (
	...
	QSYS_lab4_mm_interconnect_2_router router_001 (
	...
	QSYS_lab4_mm_interconnect_2_router_002 router_002 (
	...
	QSYS_lab4_mm_interconnect_2_router_002 router_003 (
	...
	QSYS_lab4_mm_interconnect_2_router_002 router_004 (
	...
	QSYS_lab4_mm_interconnect_2_router_002 router_005 (
	...
	QSYS_lab4_mm_interconnect_2_router_002 router_006 (
	...
	QSYS_lab4_mm_interconnect_2_router_002 router_007 (
	...
	QSYS_lab4_mm_interconnect_2_router_002 router_008 (
	...
	QSYS_lab4_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                         //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_demux cmd_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                         //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_mux cmd_mux_001 (
		.clk                 (pll_0_outclk0_clk),                                           //       clk.clk
		.reset               (alt_vip_vfr_0_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_mux cmd_mux_002 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_mux cmd_mux_003 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_mux cmd_mux_004 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_mux cmd_mux_005 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_cmd_mux cmd_mux_006 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_demux_001 rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                                           //       clk.clk
		.reset              (alt_vip_vfr_0_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_demux rsp_demux_002 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_demux rsp_demux_003 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_demux rsp_demux_004 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_demux rsp_demux_005 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_demux rsp_demux_006 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                   //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                                         //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_rsp_mux rsp_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                                         //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QSYS_lab4_mm_interconnect_2_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
